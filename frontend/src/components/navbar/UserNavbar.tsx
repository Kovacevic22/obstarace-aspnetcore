        ...
        <div className="fixed top-0 left-0 right-0 z-50 bg-[var(--color-dark)]/90 backdrop-blur-md border-b border-white/5">
            <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
                ...
                <ul className="hidden lg:flex items-center gap-8 text-[11px] font-bold uppercase tracking-[0.2em] text-white/80">
                    <li><a href="#" className="hover:text-[var(--color-accent)] transition-all">Home</a></li>
                    <li><a href="#" className="hover:text-[var(--color-accent)] transition-all">Races</a></li>
                    <li><a href="#" className="hover:text-[var(--color-accent)] transition-all">Obstacles</a></li>
                    <li><a href="#" className="hover:text-[var(--color-accent)] transition-all">My Registrations</a></li>
                </ul>
                <div className="flex items-center gap-6">
                    <div className="text-[10px] font-black uppercase tracking-widest text-[var(--color-accent)] hover:text-white cursor-pointer transition-all">Profile</div>
                    <div className="text-[10px] font-black uppercase tracking-widest text-white/30 hover:text-red-500 cursor-pointer transition-all">Logout</div>
                </div>
            </div>
        </div>
    )
