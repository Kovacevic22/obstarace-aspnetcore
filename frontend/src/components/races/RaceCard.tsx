...
export function RaceCard({race}: RaceCardProps) {
    return (
        <div className="group relative bg-[#1a2420] border border-white/5 overflow-hidden hover:border-accent/50 transition-all duration-500 shadow-2xl flex flex-col h-full">
            <div className="relative h-56 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 z-20 flex flex-col gap-2">
                    <div className="bg-accent text-dark text-[10px] font-black px-3 py-1 uppercase tracking-tighter shadow-xl">
                ...
                <div className="absolute bottom-4 right-4 z-20 bg-dark/80 backdrop-blur-md px-3 py-1 border border-white/5 flex items-center gap-2">
            ...
            <div className="p-6 flex flex-col grow">
                <div className="mb-6">
                    <h3 className="text-2xl font-black uppercase tracking-tighter leading-[1.1] group-hover:text-accent transition-colors min-h-14 line-clamp-2">
                        {race.name}
                    </h3>
